...
import BulbType from "~/assets/scripts/objects/BubType";
    ...
    return {
      ...
      form: new DefaultForm({
        ...
        ShowForm: (title, isAdd, obj) => {
          ...
          this.form.obj = new BulbType(obj);
    ...
    Save() {
      ...
      this.$refs.form.getValidate().then((re) => {
        if (!re) {
          ...
          let api = this.form.obj.Id ? API.BulbType_Edit : API.BulbType_Add;
          GetDataAPI({
            method: "post",
            url: api,
